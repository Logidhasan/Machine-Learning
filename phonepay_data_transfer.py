...
First_collumn = {"States":[], "Years":[], "Quarter":[], "Distric":[], "Insurance_count":[], "Insurance_amount":[]}
    ...
    for year in years:
        ...
        for files in file:
            ...
            for A in insurance_list ["data"]["hoverDataList"]:
                ...
                First_collumn["Distric"].append(name)
...
Second_collumn = {"States":[], "Years":[], "Quarter":[], "Distric":[], "Transaction_count":[], "Transaction_amount":[]}
    ...
    for year in years:
        ...
        for files in file:
            ...
            for B in Transaction_list ["data"]["hoverDataList"]:
                ...
                Second_collumn["Distric"].append(name)
...
First_collumn_top = {"States":[], "Years":[], "Quarter":[], "Distric":[], "Insurance_type":[], "Insurance_count":[], "Insurance_amount":[]}
    ...
    for year in years:
        ...
        for files in file:
            ...
            for A in top_insur ["data"]['districts']:
                    ...
                    First_collumn_top["Distric"].append(dist)
...
top_insur = """insert into top_insurance values (%s, %s, %s, %s, %s, %s, %s)"""
...
Top_Second_collumn = {"States":[], "Years":[], "Quarter":[], "Distric":[], "Transaction_type":[], "Transaction_count":[], "Transaction_amount":[]}
    ...
    for year in years:
        ...
        for files in file:
            ...
            for B in Transaction_list ["data"]["districts"]:
                ...
                Top_Second_collumn["Distric"].append(dist)
...
top_insur = """insert into top_transaction values (%s, %s, %s, %s, %s, %s, %s)"""
